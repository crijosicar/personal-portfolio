...
export type ScrollWrapperContext = { selectedSection: number; setSelectedSection: Function, sections: string[] };

const defaultContext: ScrollWrapperContext = {selectedSection: 1, setSelectedSection: () => {}, sections};
