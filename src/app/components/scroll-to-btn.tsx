...
export default function ScrollToBtn() {
    ...
    return (
        <div className="fixed bottom-0 left-0 flex h-12 w-screen justify-evenly">
            <Link href={'#'} className={'mx-0.3 animate-pulse'} onClick={() => scrollTo(activeSectionIdx)}>
                {activeSectionIdx > 0 ? (
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className={`h-8 w-8 font-semibold ${activeSectionIdx === 4 ? 'text-white hover:text-primary' : 'hover:text-seconday text-primary'}`}
                    >
                        <path
                            fillRule="evenodd"
                    ...
                    <svg
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className={`font-semibold ${activeSectionIdx === 4 ? 'text-white hover:text-primary' : 'hover:text-seconday text-primary'} h-8 w-8`}
                    >
                        <path
                            strokeLinecap="round"
