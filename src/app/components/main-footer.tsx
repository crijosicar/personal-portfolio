        ...
        <footer id={'bottom-bar'} className="container mx-auto px-10 py-5">
            <div className={'flex justify-evenly'}>
                <div className={'flex flex-1 flex-col gap-1'}>
                    <Link
                        href={"mailto:hello@cristiansierra.dev?subject=Let's%20talk%20about%20my%20project"}
                        className={'mx-0.5 flex-1 text-fourth dark:text-white'}
                    >
                        hello@cristiansierra.dev
                    </Link>
                    <Link href={'tel:+15482551056'} className={'text-fourth dark:text-white'}>
                        +1-548-255-1056
                    </Link>
            ...
            <div className={'flex justify-start'}>
                <Link href={'/'} className="font-semibold text-fourth hover:text-secondary dark:text-white">
