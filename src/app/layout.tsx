...
import { BreadCrumbsWrapper } from '@/app/context/breadcrumbs-wrapper';
                        ...
                        <ApolloWrapper>
                            <Suspense fallback={<Spinner />}>
                                <div className="flex h-screen flex-col">
                                    ...
                                    <main className={'border-b-2 border-[#142966]'}>
                                    ...
                                    <footer id={'bottom-bar'} className="container mx-auto px-10 py-5">
                                        ...
                                        <div className={'flex justify-start'}>
                                            <Link href={'/'} className="font-semibold text-fourth hover:text-secondary">
