            ...
            <header id={'top-navbar'} className="container mx-auto px-10 py-5">
                <div className={'flex'}>
                    <div className={'flex-1 flex items-center justify-start'}>
                        <Link href={'/'} className="flex-1 font-semibold">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 527.34 85.32" className={'max-h-8'}>
                                <text fontFamily="JosefinSans-Bold, 'Josefin Sans'" fontSize="76.59" fontWeight="700"
                                      transform="translate(0 66.48)">
                                    <tspan fill="#142966" x="0" y="0">&lt;</tspan>
                                    <tspan fill="#3350db" x="42.51" y="0">CRISTIANS</tspan>
                    ...
                    <div className={'flex-1 flex items-center justify-end'}>
                        <Link href={'/hire-me'}
                              className={'font-semibold text-primary dark:text-white mx-0.5 hover:text-secondary'}>
