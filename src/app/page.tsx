    ...
    return (
        <div className={'h-full w-full'}>
            ...
            <section id={'hero'} className={'w-full'}>
                <div className={'flex flex-col items-center justify-center gap-1 px-20 md:flex-row md:px-10'}>
                    <div className={'flex flex-col md:basis-2/3'}>
                        <div>
                            <p className={'text-center text-5xl text-primary md:text-right'}>
                        ...
                        <div className={'my-3'}>
                            <p className={'text-center text-2xl text-gray-700 md:text-right'}>
                                {
            ...
            <section id={'what-do-i-do'} className={'w-full'}>
                <div className={'p-10'}>
                    <div className={'container mx-auto px-5 py-5'}>
                        <h1 className={'text-5xl font-semibold text-primary'}>How can I help?</h1>
                        ...
                        <div className={'flex flex-col gap-5 md:flex-row'}>
                            ...
                            >
                                ...
                                <div className={'flex h-[calc(35vh)] flex-col p-8'}>
                                    ...
                                    <div className={'text-wrap flex flex-auto items-center'}>
            ...
            <section id={'works'} className={'w-full'}>
                <div className={'p-10'}>
                    <div className={'container mx-auto px-5 py-5'}>
                        <h1 className={'text-5xl font-semibold text-primary'}>Works</h1>
                        <p className={'mt-2 text-2xl'}>
                            {
                                'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur laoreet eleifend euismod.'
                            }
                        ...
                        <div className={'md:pl-10'}>
                            <div className={'flex items-center gap-1'}>
                                <svg
                                    ...
                                    strokeWidth={1.5}
                                    stroke="currentColor"
                                    className="h-10 w-10 font-semibold text-primary"
                                >
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                ...
                                <h1 className={'text-5xl font-semibold text-primary'}>Have a Project?</h1>
                            </div>
                            <div className={'flex items-center'}>
                                <p className={'my-2 pr-1 text-2xl text-tertiary hover:text-secondary'}>
                                    Let&apos;s talk about it.
                                </p>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    strokeWidth={1.5}
                                    stroke="currentColor"
                                    className="h-7 w-7 text-tertiary hover:text-secondary"
                                >
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
