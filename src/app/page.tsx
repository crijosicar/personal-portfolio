        ...
        <div className={'w-full h-full'}>
            ...
            <section id={'hero'} className={'w-full'}>
                <div className={'px-20 md:px-10 flex flex-col md:flex-row gap-1 items-center justify-center'}>
                    <div className={'md:basis-2/3 flex flex-col'}>
                        <div>
                            <p className={'text-5xl text-primary text-center md:text-right'}>Hello, I&apos;m <label
                                className={'font-bold'}>Cristian</label>, an enthusiastic
                                <label className={'ml-2 text-5xl font-semibold text-tertiary max-w-prose'}>Software
                                    Engineer</label>
                            </p>
                        </div>
                        <div className={'my-3'}>
                            <p className={'text-2xl text-gray-700 text-center md:text-right'}>{"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur laoreet eleifend euismod."}</p>
                        </div>
                    ...
                    <div className={'flex items-center justify-center p-10 w-full'}>
                        <div className={'flex flex-col md:flex-row gap-5'}>
                            <Link className={`flex-1 bg-tertiary text-white max-w-md hover:animate-pulse`}
                                ...
                                <div className={'p-8 h-[calc(35vh)] flex flex-col'}>
                                    ...
                                    <div className={'flex-auto flex items-center text-wrap'}>
                        ...
                        <div className={'flex flex-col md:flex-row gap-10'}>
                            {map(works, (work, index) => {
                                const {
                                    ...
                                    startDate,
                                    slug
                                } = pick(work, ['company', 'title', 'endDate', 'startDate', 'slug']);
                                    ...
                                    <h1 className={'text-5xl font-semibold text-white hover:animate-pulse'}>
                                        <div className="flex items-center justify-center">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                 strokeWidth={1.5} stroke="currentColor" className="w-24 h-24">
                                                <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <section id={'have-a-project'} className={'w-full'}>
                <div className={'px-20 py-10 md:px-10 flex flex-col md:flex-row gap-1 items-center justify-center'}>
                        ...
                        <div className={'md:pl-10'}>
                            <div className={'flex items-center gap-1'}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth={1.5}
                                     stroke="currentColor"
                                     className="w-10 h-10 font-semibold text-primary">
                                    <path strokeLinecap="round" strokeLinejoin="round"
                            ...
                            <div className={'flex items-center'}>
                                <p className={'text-2xl pr-1 my-2 text-tertiary hover:text-secondary'}>Let&apos;s talk
                                    about it.
                                </p>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-tertiary hover:text-secondary">
                                    <path strokeLinecap="round" strokeLinejoin="round"
                    ...
                    <div className={'md:flex-1 container md:px-10'}>
                        <HomeContactForm/>
                    </div>
                </div>
            </section>
            ...
            <section id={'clients'} className={'w-full bg-fourth'}>
                <div className="pt-10 flex items-center justify-center gap-1">
                    <p className={'text-5xl font-semibold text-white'}>Clients</p>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                         stroke="currentColor" className="w-10 h-10 font-semibold text-white">
                        <path strokeLinecap="round" strokeLinejoin="round"
