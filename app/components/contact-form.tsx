        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className={'my-4'}>
                ...
                <div className={'border-b-2 border-t-0 border-l-0 border-r-0 border-grey-dark'}>
                    <input {...register("name")} type={'text'} className={'border-none w-full bg-transparent outline-none text-primary'} />
                </div>
            ...
            <div className={'my-4'}>
                ...
                <div className={'border-b-2 border-t-0 border-l-0 border-r-0 border-grey-dark'}>
                    <input {...register("email")} type={'text'} className={'border-none w-full bg-transparent outline-none text-primary'}/>
                </div>
            ...
            <div className={'my-4'}>
                ...
                <div className={'border-b-2 border-t-0 border-l-0 border-r-0 border-grey-dark'}>
                    <textarea {...register("message")} rows={4} cols={50} className={'border-none w-full bg-transparent outline-none text-primary'}></textarea>
                </div>
